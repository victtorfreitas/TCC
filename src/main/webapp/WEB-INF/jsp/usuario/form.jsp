...
<form action="${linkTo[UsuarioController].saveOrUpdate(null)}" method="post">

	<input type="text" id="id" name="usuario.id" class="form-control" value="${usuario.id}" hidden="true"/>

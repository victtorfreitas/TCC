...
<div class="card">
	...
	<div class="card-body">
		<form action="${linkTo[UsuarioController].removeById(null)}"
			method="post">
				...
				<div class="form-row">
					<div class="col-md-6">
						<div class="form-label-group">
							<input id="matricula" name="usuario.id" type="text"
								class="form-control" placeholder="Matricula:" value="${user.id}" />
					...
					<div class="col-md-6" style="line-height: 2.1;">
						<button type="submit" class="btn btn-outline-primary active"
							...
							<span class="fas fa-trash"> </span> Remover
						</button>
						<button type="reset" class="btn btn-outline-warning active"
							style="line-height: 2.1;">Limpar</button>
					</div>
				</div>
			</div>
		</form>
